...
function Wellcome() {
  return (
    <div className="flex flex-col place-content-center items-center bg-background text-gray-300 p-8 w-full h-screen mt-10">
      ...
      <Link className="w-full" href="/trend"><button className="bg-amber-600 text-gray-950 font-bold w-full rounded-md p-2 mt-10 hover:bg-gray-300 transition-all ease-in ">
        Comenzar
      </button></Link>
    </div>
  );
